...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <div class="row">
			...
			<div class="col-lg-4">
                <div class="thumbnail">
				<img class="img-rounded" src="http://localhost/basic/web/images/MVC.jpg" alt="Modelo Vista Controlador">
					<div class="caption">
			...
			<div class="col-lg-4">
                <div class="thumbnail">
				<img class="img-rounded" src="http://localhost/basic/web/images/selenium.jpg" alt="Selenium">
					<div class="caption">
		...
		<div class="row">		
			<div class="col-lg-6">
                <div class="thumbnail">
				<img class="img-rounded" src="http://localhost/basic/web/images/qa.jpg" alt="Software QA">
					<div class="caption">
            ...
            <div class="col-lg-6">
                <div class="thumbnail">
				<img class="img-rounded" src="http://localhost/basic/web/images/html5.jpg" alt="HTML5">
					<div class="caption">
					<p><h2>HTML5<a class="pull-right btn btn-primary" href="http://www.ssrangelandres.com/yii2/web/pdf/HTML5.pdf" target="_blank">Artículo &raquo;</a></h2>
					<p>
